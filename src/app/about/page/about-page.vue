<template>
  <div class="max-w-4xl mx-auto">
    <h1 class="text-4xl font-bold text-gray-900 mb-8">Over mij</h1>
    ...
    <div class="bg-white rounded-lg shadow-md p-8 space-y-6">
      ...
      <div>
        ...
        <ul class="list-disc list-inside text-lg text-gray-700">
          <li>Programmeertalen: JavaScript, TypeScript, Python, C#</li>
          <li>Frameworks: Vue.js, React, Next.js, Remix.run</li>
          <li>Tools: Git, Docker</li>
        </ul>
      </div>

      <div>
        <h2 class="text-2xl font-semibold text-gray-800">Het bedrijf</h2>
        <p>Ik loop stage bij Taglayer. Dit bedrijf is gevestigd in Antwerpen.</p>
        <p>Wat ik hier zal leren:</p>
        <ul class="list-disc list-inside text-lg text-gray-700">
          <li>Vue.js</li>
        </ul>
      </div>
